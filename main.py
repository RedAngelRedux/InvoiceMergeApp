...
# from core.menu_registry import discover_actions
...
def main():
    ...
    try:
        ...
        # # First cli Attempt
        # ui_text = load_config("ui_text.json")
        # actions = discover_actions()

        # for i, action in enumerate(actions, 1):
        #     label = get_label(ui_text,action["label_key"],action["label_key"])
        #     print(f"{i}. {label}")

        # Second Dynamic CLI Attampt        
        start_cli()
